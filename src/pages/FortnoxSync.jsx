...
function FortnoxConnectionPanel() {
  ...
  const handleAuthorize = () => {
    const authUrl = 'https://apps.fortnox.se/oauth-v1/auth?client_id=C84gmzGW0STm&redirect_uri=https%3A%2F%2Flager-ai-7d26cc74.base44.app%2FFortnoxSync&scope=article&state=fortnox_connect&access_type=offline&response_type=code';
