...
function FortnoxConnectionPanel({ onConnected }) {
  ...
  const handleAuthorize = () => {
    const authUrl = 'https://apps.fortnox.se/oauth-v1/auth?client_id=mp08u6gAFPz2&redirect_uri=https%3A%2F%2Flager-ai-7d26cc74.base44.app%2FFortnoxSync&scope=companyinformation%20article%20project%20purchase&state=fortnox_connect&access_type=offline&response_type=code';
...
function FortnoxConnectionPanelInline() {
  ...
  const handleAuthorize = () => {
    window.open('https://apps.fortnox.se/oauth-v1/auth?client_id=mp08u6gAFPz2&redirect_uri=https%3A%2F%2Flager-ai-7d26cc74.base44.app%2FFortnoxSync&scope=companyinformation%20article%20project%20purchase&state=fortnox_connect&access_type=offline&response_type=code', '_blank');
  };
         ...
         >
           <div className="flex items-center justify-between">
             ...
             <div className="group relative">
               <Button
                 onClick={() => window.open('https://apps.fortnox.se/oauth-v1/auth?client_id=mp08u6gAFPz2&redirect_uri=https%3A%2F%2Flager-ai-7d26cc74.base44.app%2FFortnoxSync&scope=companyinformation+article+project+purchase&state=fortnox_connect&access_type=offline&response_type=code', '_blank')}
                 variant="outline"
                 size="sm"
