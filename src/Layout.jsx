...
function LayoutComponent({ children, currentPageName }) {
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <nav className="hidden md:flex fixed bottom-0 left-0 right-0 h-20 bg-white/5 backdrop-blur-2xl border-t border-white/10 shadow-white/5 z-50 overflow-x-auto px-4" style={{ boxShadow: '0 0 20px rgba(255,255,255,0.05)' }}>
      ...
      {/* Mobile Bottom Nav */}
      <nav className="md:hidden fixed bottom-0 left-0 right-0 h-20 bg-white/5 backdrop-blur-2xl border-t border-white/10 z-50 overflow-x-auto px-4 pb-safe" style={{ boxShadow: '0 0 20px rgba(255,255,255,0.05)' }}>
