...
function LayoutContent({ children, currentPageName }) {
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <nav className="hidden md:flex fixed top-0 left-0 right-0 h-14 bg-slate-700/90 backdrop-blur-md border-b border-white/10 shadow-lg z-50 px-6">
        <div className="flex items-center gap-1 w-full">
          ...
          {/* Admin sub-items */}
          <div className="flex items-center gap-1 ml-auto border-l border-white/20 pl-4">
      ...
      {/* Main Content */}
      <main className="md:pt-14 pb-24 md:pb-24 min-h-screen will-change-auto" style={{ paddingTop: 'calc(3.5rem + env(safe-area-inset-top))' }}>
        <ErrorBoundary>
